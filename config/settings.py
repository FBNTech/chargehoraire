...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,fabonk.pythonanywhere.com,.onrender.com,webapp-2829980.pythonanywhere.com,www.votredomaine.com,votredomaine.com', cast=Csv())
...
LOGGING = {
    ...
    'handlers': {
        ...
        'attribution_file': {
            'level': 'DEBUG',
            'class': 'logging.FileHandler',
            'filename': os.path.join(BASE_DIR, 'logs', 'attribution.log'),
            'formatter': 'verbose',
            'encoding': 'utf-8',
        },
        'console': {
    ...
    'loggers': {
        ...
        'attribution': {
            'handlers': ['attribution_file', 'console'],
            'level': 'DEBUG',
            'propagate': False,
        },
    },
